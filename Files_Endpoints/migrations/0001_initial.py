    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_blob', models.BinaryField(help_text='Binary file data stored in database')),
        ...
        migrations.AddIndex(
            model_name='folder',
            index=models.Index(fields=['user'], name='files_folde_user_id_cdb775_idx'),
        ),
        migrations.AddIndex(
            model_name='folder',
        ...
        migrations.AddIndex(
            model_name='file',
            index=models.Index(fields=['folder'], name='files_file_folder__f8bf0f_idx'),
        ),
        migrations.AddIndex(
            model_name='file',
        ...
        migrations.AddIndex(
            model_name='share',
            index=models.Index(fields=['target_user'], name='files_share_target__7d0f88_idx'),
        ),
        migrations.AddIndex(
            model_name='share',
            index=models.Index(fields=['folder'], name='files_share_folder__2b5d8b_idx'),
        ),
        migrations.AddIndex(
            model_name='share',
