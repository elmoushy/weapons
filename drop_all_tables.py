    ...
    with connection.cursor() as cursor:
        ...
        cursor.execute("""
            ...
            WHERE (
                ...
                table_name LIKE 'NEWS_%' OR
                table_name LIKE 'NEWS_SERVICE_%' OR
                table_name LIKE 'FILES_%' OR
                table_name LIKE 'FILES_ENDPOINTS_%' OR
    ...
    with connection.cursor() as cursor:
        cursor.execute("""
            ...
            AND (
                ...
                a.table_name LIKE 'NEWS_%' OR
                a.table_name LIKE 'NEWS_SERVICE_%' OR
                a.table_name LIKE 'FILES_%' OR
                a.table_name LIKE 'FILES_ENDPOINTS_%' OR
    ...
    with connection.cursor() as cursor:
        ...
        cursor.execute("""
            ...
            WHERE (
                ...
                sequence_name LIKE 'NEWS_%' OR
                sequence_name LIKE 'NEWS_SERVICE_%' OR
                sequence_name LIKE 'FILES_%' OR
                sequence_name LIKE 'FILES_ENDPOINTS_%' OR
